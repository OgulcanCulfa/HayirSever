  ...
  render() {
    return (
      <div className="container w-75 d-flex align-items-center">
        <div className="card card-body my-lg-4">
          <h1 className="text-center">HayırSever uygulamasına hoşgeldiniz!</h1>
          <div className="row">
          ...
          <div className="row no-gutters p-md-5 p-2">
            ...
            <div className="col-md-4 col-12 px-2">
              ...
              <p className="mt-3 text-center">
                ...
                fotoğrafını da çekerek paylaşabileceğiniz bir sistem sunuyoruz.
              </p>
            </div>
            <div className="col-md-4 col-12 px-2">
              <div className="text-center">
              ...
              <p className="mt-3 text-center">
                Yardım almak ya da vermek istediğinizde sistemin içinde bulunan
                entegre mesejlaşma uygulamasıyla kolayca iletişim
                kurabilirsiniz.
              </p>
            </div>
          </div>
